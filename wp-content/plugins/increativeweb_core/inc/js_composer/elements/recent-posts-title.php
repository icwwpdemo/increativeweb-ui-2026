...
class WPBakeryShortCode_icw_recent_posts_title extends WPBakeryShortCode {
  ...
  protected function content( $atts, $content = null ) {
    ...
    ?>
<div class="recent-posts-title <?php echo esc_attr( $wrapper_class ); ?>" <?php if( $animate_block == 'yes' && $animation_delay != '' ) { echo 'data-wow-delay="' . esc_attr( $animation_delay ) . '"'; } ?>>
  <?php if( $tagline ) { ?>
...
vc_map( array(
  "base" => "icw_recent_posts_title",
  "name" => __( 'Recent Posts Title', 'ICWTHEME' ),
