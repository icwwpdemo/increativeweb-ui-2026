...
class WPBakeryShortCode_icw_icon_box extends WPBakeryShortCode {
  ...
  protected function content( $atts, $content = null ) {
    ...
    ?>
<div class="icon-box <?php echo esc_attr( $wrapper_class ); if ( strlen( $link['url'] ) > 0 ) { echo 'is-hover'; }?>" <?php if( $animate_block == 'yes' && $animation_delay != '' ) { echo 'data-wow-delay="' . esc_attr( $animation_delay ) . '"'; } ?>>
