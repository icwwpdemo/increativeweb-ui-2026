...
class WPBakeryShortCode_icw_recent_cases extends WPBakeryShortCode {
    ...
    <div class="swiper-wrapper">
      ...
      <div class="swiper-slide">
        <div class="cases">
          <figure><img src="<?php echo esc_url( $thumbnail_image ); ?>" alt="<?php the_title_attribute(); ?>">
...
vc_map( array(
    "base" 			    => "icw_recent_cases",
    "name" 			    => __( "Recent Cases", "ICWTHEME" ),
