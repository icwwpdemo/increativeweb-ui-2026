...
<ul class="social-media-icons">
	...
	<li><a href="https://api.whatsapp.com/send?text=<?php echo str_replace(" ", "%20", $titleget); ?>%20%20(<?php echo esc_html( get_bloginfo( 'name' ) ); ?>)%20%20--%20<?php echo $permalink; ?>" data-action="share/whatsapp/share" title="Share on WhatsApp" data-bs-toggle="tooltip" target="_blank"><em class="icons icon-whatsapp"></em></a></li>
</ul>
</div>