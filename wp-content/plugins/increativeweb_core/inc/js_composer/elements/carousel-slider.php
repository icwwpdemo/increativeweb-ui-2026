...
class WPBakeryShortCode_icw_carousel_slider extends WPBakeryShortCode {
...
$wrapper_class = array();
    ...
    ?>
<div class="carousel-slider <?php echo esc_attr( $wrapper_class ); ?>" <?php if( $animate_block == 'yes' && $animation_delay != '' ) { echo 'data-wow-delay="' . esc_attr( $animation_delay ) . '"'; } ?>>
  <div class="swiper-wrapper">
    ...
    foreach ( $details as $data ) {
      ...
      $new_line[ 'tags' ] = isset( $new_line[ 'tags' ] ) ? $new_line[ 'tags' ] : '';
    ...
    <div class="swiper-slide">
      <figure><img src="<?php echo esc_url($images[0]);?>" alt="<?php echo esc_attr($accordion['title']);?>">
        <figcaption>
          <?php if($accordion['tags']) { ?>
          <small><?php echo esc_attr($accordion['tags']);?></small>
          <?php } ?>
          <?php if($accordion['title']) { ?>
          <h3><a href="<?php echo esc_url($accordion['link_url']); ?>"><?php echo esc_html($accordion['title']);?></a></h3>
          <?php } ?>
        </figcaption>
      </figure>
    </div>
...
vc_map( array(
  "base" => "icw_carousel_slider",
  "name" => __( 'Carousel Slider', 'ICWTHEME' ),
