...
class WPBakeryShortCode_icw_our_history extends WPBakeryShortCode {
  ...
  protected function content( $atts, $content = null ) {
    ...
    ?>
<div class="our-history <?php echo esc_attr( $wrapper_class ); ?>" <?php if( $animate_block == 'yes' && $animation_delay != '' ) { echo 'data-wow-delay="' . esc_attr( $animation_delay ) . '"'; } ?>>
  <div class="swiper-wrapper">
    ...
    <div class="swiper-slide">
      <?php if($accordion['date']) { ?>
      <b><?php echo esc_attr($accordion['date']);?></b>
      <?php } ?>
      <figure><img src="<?php echo esc_url($images[0]);?>" alt="<?php echo esc_attr($accordion['description']);?>"></figure>
...
vc_map( array(
  "base" => "icw_our_history",
  "name" => __( 'Our History', 'ICWTHEME' ),
