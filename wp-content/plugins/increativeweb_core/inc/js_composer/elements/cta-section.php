...
class WPBakeryShortCode_icw_cta_section extends WPBakeryShortCode {
  ...
  protected function content( $atts, $content = null ) {
    ...
    ?>
<div class="cta-section <?php echo esc_attr( $wrapper_class ); ?>" <?php if( $animate_block == 'yes' && $animation_delay != '' ) { echo 'data-wow-delay="' . esc_attr( $animation_delay ) . '"'; } ?>>
  <?php if( $tagline ) { ?>
...
vc_map( array(
  "base" => "icw_cta_section",
  "name" => __( 'CTA Section', 'ICWTHEME' ),
