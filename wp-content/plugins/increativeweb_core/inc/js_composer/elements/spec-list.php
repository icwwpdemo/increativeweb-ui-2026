...
class WPBakeryShortCode_icw_spec_list extends WPBakeryShortCode {
	...
	<ul class="spec-list <?php echo esc_attr( $wrapper_class ); ?>" <?php if( $animate_block == 'yes' && $animation_delay != '' ) { echo 'data-wow-delay="' . esc_attr( $animation_delay ) . '"'; } ?> id="accordion" role="tablist">
      ...
      $idd++;
		...
		<li>
		<strong><?php echo esc_html($accordion['title']);?></strong>
			 <b><?php echo esc_html($accordion['description']);?></b>
            </li>
...
vc_map( array(
	"base" 			    => "icw_spec_list",
	"name" 			    => __( 'Specification List', 'ICWTHEME' ),
